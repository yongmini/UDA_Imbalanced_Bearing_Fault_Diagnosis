...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='DA',choices=['DA','base'], help='the name of the method')
    parser.add_argument('--model_name', type=str, default='cnn_features_1d', help='the name of the model')
    parser.add_argument('--data_name', type=str, default='CWRU',choices=['CWRU','JNU'] ,help='the name of the data')
